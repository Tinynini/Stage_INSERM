...
all_species <- read_tsv('W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Dataframe/Sliced_Taxo_Result.tsv', col_types = "cccccccdddddd") %>%
  as.data.frame
...
for (i in 1:6) # Permet de parcourir les 6 niveaux taxonomiques etudies (d espece a phylum)
{
  ...
  path_start <- "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Arbre/"
  path_end <- ".tree"
  ...
  m_path_start <- "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Matrice/Sliced_Matrix_"
  m_path_end <- ".tsv"
  ...
  debu <- "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Plot/Tree_plot/Sous_arbres/rep~blaNDM-18/Sub_tree_"
  fine <- ".png" 
  ...
  end_fr <- '_fr.png'
  end_en <- '_en.png'
  path_fr = "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Plot/Distance_plot/Tot_distances/FR"
  path_en = "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Plot/Distance_plot/Tot_distances/EN"
  ...
  fin_fr <- '_fr.png'
  fin_en <- '_en.png'
  dir_fr = "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Plot/Tree_plot/Arbre_sous_arbres/FR"
  dir_en = "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Plot/Tree_plot/Arbre_sous_arbres/EN"
  # Pour definir les titres de plots
...
save(liste_uni_gene,  liste_tree_liste, file = "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/listes.RData")
