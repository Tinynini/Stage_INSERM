...
taxo <- read_tsv('W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Dataframe/sliced_all_species_taxo.tsv', col_types = "cccccccc") %>% 
  as.data.frame()
...
write.table(taxo, "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Dataframe/Sliced_Taxo_Result.tsv", sep = '\t', row.names = FALSE, col.names = TRUE)
...
generate_plot_fr <- function(level_share, level_name)
{
  ...
  path = "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Plot/Taxo_plot/FR"
...
generate_plot_en <- function(level_share, level_name)
{
  ...
  path = "W:/ninon-species/output/Output_M2/AV_AP_ARG/DF/Plot/Taxo_plot/EN"
