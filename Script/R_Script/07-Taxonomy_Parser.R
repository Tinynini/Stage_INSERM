...
#### Ouverture de bac120_taxonomy_r95.tsv (ou de bac120_taxonomy_r95_new.tsv pour la 2nd version) & récupération des données ####
...
for (i in 2:ncol(taxonomy)) # Suppression des préfix indiquant le niveau taxonomique (superflus car déjà indiqués par les nom de colonnes)
{
