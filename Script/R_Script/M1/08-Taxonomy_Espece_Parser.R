...
write.table(ARG_Species, "W:/ninon-species/output/Output_M1/Dataframe/ARG_Species.tsv", sep = '\t', row.names = FALSE, col.names = TRUE)
#write.table(ARG_Species, "W:/ninon-species/output/Output_M1/Dataframe/New_ARG_Species.tsv", sep = '\t', row.names = FALSE, col.names = TRUE)