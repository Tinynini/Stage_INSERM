...
M_100_species='/home/ninon.robin/alt_bash_script/output/100M_species.tsv'
...
M_100_share='/home/ninon.robin/alt_bash_script/output/100M_share.tsv'
...
paste ${Coli_species} ${Salm_species} ${Klebs_species} ${G_species} ${M_100_species} ${M_10_species} ${K_1000-100_species} ${K_10-1_species} > /home/ninon.robin/alt_bash_script/output/matrix.tsv
paste ${centro} ${Coli_share} ${Salm_share} ${Klebs_share} ${G_share} ${M_100_share} ${M_10_share} ${K_1000-100_share} ${K_10-1_share} | sed 's/\t//g' >> /home/ninon.robin/alt_bash_script/output/matrix.tsv
