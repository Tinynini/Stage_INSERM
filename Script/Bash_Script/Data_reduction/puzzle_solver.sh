...
M_100-1_species='/home/ninon.robin/alt_bash_script/output/Puzzle_matrix/100M-1_species.tsv'
M_100-2_species='/home/ninon.robin/alt_bash_script/output/Puzzle_matrix/100M-2_species.tsv'
...
M_100-1_share='/home/ninon.robin/alt_bash_script/output/Puzzle_matrix/100M-1_share.tsv'
M_100-2_share='/home/ninon.robin/alt_bash_script/output/Puzzle_matrix/100M-2_share.tsv'
...
paste ${Coli_species} ${Salm_species} ${Klebs_species} ${G_species} ${M_100-1_species} ${M_100-2_species} ${M_10_species} ${M_1_species} ${K_100_species} ${K_10_species} > /home/ninon.robin/alt_bash_script/output/matrix.tsv
paste ${centro} ${Coli_share} ${Salm_share} ${Klebs_share} ${G_share} ${M_100-1_share} ${M_100-2_share} ${M_10_share} ${M_1_share} ${K_100_share} ${K_10_share} | sed 's/\t//g' >> /home/ninon.robin/alt_bash_script/output/matrix.tsv
