...
paste ${Coli_species} ${Salm_species} ${Klebs_species} ${G_species} ${M_100-1_species} ${M_100-2_species} ${M_10_species} ${M_1_species} ${K_100_species} ${K_10_species} | sed 's/\t//g' > /home/ninon.robin/alt_bash_script/output/full_matrix.tsv
paste ${centro} ${Coli_share} ${Salm_share} ${Klebs_share} ${G_share} ${M_100-1_share} ${M_100-2_share} ${M_10_share} ${M_1_share} ${K_100_share} ${K_10_share} | sed 's/\t//g' >> /home/ninon.robin/alt_bash_script/output/full_matrix.tsv
